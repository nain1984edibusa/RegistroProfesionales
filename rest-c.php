...
<table align="center" width="100%" border='1' style="border-style:none;" cellspacing='4' bordercolor='#0000ff'>
  <tr>
      <td align="center" align='center' class='literatura' colspan='4'><B> <font size='+1'>REGISTRO DE PROFESIONALES - RESTABLECIMIENTO DE CONTRASE&Ntilde;A</font></B>
			</td>
  </tr>
</table>
		<hr>
	<form name="post1" action="" method="post" onSubmit="" >
                ...
                <table cellpadding='4' border='0' align='center'><tr><td class='literatura' >
                        Su usuario es el n&uacute;mero de documento de identificaci&oacute;n (c&eacute;dula o pasaporte) con que solicit&oacute; el registro
                 </td></tr></table>
 
		<table  class='seccion' border='0' bgcolor='#ffffff' cellspacing='3' align='center' width='40%'>
			<tr valign='middle'>
				<th colspan='4' >
				   <h1> <img src='image/logini.png' > RESTABLECER CONTRASE&Ntilde;A</h1>					
				</th>
			</tr>
			<tr>
			<tr >
			...
			<tr>
				<td  align='center' colspan='4'>
					<input type="button" class='buton' name="send" value="ACEPTAR" onFocus="" onBlur="" onClick="if(valid()){document.post1.action='rest-c2.php';document.post1.submit();}">
				</td>
			</tr>
		</table>
	</form><br><br><br>
